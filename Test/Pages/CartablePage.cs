...
namespace Test.Pages
{
    ...
    public class CartablePage
    {
        ...
        //private static bool m_IsCartableLoaded;
       ...
       // private IWebElement m_ImgCartable => driver.FindElement( By.Id( "logo-image" ) );
        ...
        public void LoadFollowupCartable( )
        {
            ...
            driver.Manage( ).Timeouts( ).ImplicitWait = TimeSpan.FromSeconds( 5 );
            var followupcartable = driver.FindElement( By.XPath( "//dt[@class='item empty selected']/a[1]" ));
            Assert.AreEqual (true , followupcartable.Displayed );
