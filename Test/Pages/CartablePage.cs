...
namespace Test.Pages
{
    ...
    public class CartablePage
    {
        ...
        public void CartableLoaded( )
        {
            ...
            IWebElement m_BtnNewMemorandom= webDriverWait.Until( ExpectedConditions.ElementIsVisible( By.Id( "38153e8e-0e5e-4ad8-bc84-fa9e810023d2" )));
            //IWebElement m_BtnNewEform= webDriverWait.Until( ExpectedConditions.ElementIsVisible( By.Id( "43fa13dd-cb8f-4daf-be7a-c3712435c10b" )));
            //IWebElement m_BtnNewInternalLetter= webDriverWait.Until( ExpectedConditions.ElementIsVisible( By.Id( "e6b0b89c-f8b3-40ca-8c13-935a9032c662" )));
            //IWebElement m_BtnRefresh= webDriverWait.Until( ExpectedConditions.ElementIsVisible( By.Id( "7d7b23e0-7b19-4e61-a50b-44c3ac6a6d74" )));
