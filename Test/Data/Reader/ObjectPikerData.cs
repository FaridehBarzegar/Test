        ...
        public static IEnumerable<ObjectPiker> ReadReciverDataesFromExcel()
        {
            ...
            for (int i = 1; i < rowCount; i++)
            {
                objectPikerDatas.Add(new ObjectPiker
                {
                    ...
                    userLoginReciver = worksheet.Cells[i, 27].Value?.ToString().Trim(),
                    userLoginTranscriptReciver = worksheet.Cells[i, 28].Value?.ToString().Trim(),
                    userLoginTranscriptReciver2 = worksheet.Cells[i, 29].Value?.ToString().Trim()
                });
            };
